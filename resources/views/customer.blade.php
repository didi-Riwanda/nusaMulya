    ...
    <section class="service_section layout_padding">
        <div class="container">
            <div class="heading_container">
                ...
                <p>
                    Pelanggan dan Pengunjung yang telah memakai jasa kami.
                </p>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="box" style="padding-top: 148px; padding-bottom: 148px;">
                        <div class="img-box">
                            <img src="images/customer/1.png" alt="Gallery 1" class="rounded">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="box" style="padding-top: 148px; padding-bottom: 148px;">
                        <div class="img-box">
                            <img src="images/customer/2.png" alt="Gallery 1" class="rounded">
                        </div>
                    </div>
                </div>
